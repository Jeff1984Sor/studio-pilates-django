# Generated by Django 5.2.5 on 2025-08-09 22:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crefito', models.CharField(blank=True, help_text='Apenas para instrutores', max_length=20, null=True)),
                ...
                ('perfil', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='accounts.perfilusuario', verbose_name='Perfil de Acesso')),
